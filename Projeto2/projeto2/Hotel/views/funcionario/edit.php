<?php
    // Buscar as informações do Funcionario para atualizar
    require "../../autoload.php";

    $dao = new FuncionarioDAO();
    $funcionario = $dao->find($_GET['id']);
?>
                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control" value="<?= $funcionario->getNome() ?>"  placeholder="Digite o nome completo" required>
                        </p>

                        <p class="form-group">
                            <label for="cargo">Cargo:</label>
                            <input type="text" name="cargo" id="cargo" class="form-control" value="<?= $funcionario->getCargo() ?>" placeholder="Digite o cargo" required>
                        </p>

                        <p class="form-group">
                            <label for="salario">Salário:</label>
                            <input type="number" step="0.01" name="salario" id="salario" class="form-control" value="<?= $funcionario->getSalario() ?>"  placeholder="Digite o salário (ex: 2500.50)" required >
                        </p>
