                ...
                <div class="my-4">
                    ...
                    <form action="insert.php" method="post">
                        ...
                        <p class="form-group">
                            ...
                            <input type="text" name="cargo" id="cargo" class="form-control" placeholder="Digite o cargo do funcionário" required>
                        </p>

                        <p class="form-group">
                            <label for="salario">Salário:</label>
                            <input type="number" step="0.01" name="salario" id="salario" class="form-control" placeholder="Digite o salário (ex: 2500.00)" required>
                        </p>
