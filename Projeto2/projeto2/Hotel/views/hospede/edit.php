<?php
    // Buscar as informações do Hospede para atualizar
                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control" value="<?= $hospede->getNome() ?>" required>
                        </p>

                        <p class="form-group">
                            <label for="cpf">CPF</label>
                            <input type="text" name="cpf" id="cpf" class="form-control" value="<?= $hospede->getCpf() ?>" required>
                        </p>

                        <p class="form-group">
                            <label for="cep">CEP</label>
                            <input type="text" name="cep" id="cep" class="form-control" value="<?= $hospede->getCep() ?>" required>
                        </p>

                        <p class="form-group">
                            <label for="numero">Número</label>
                            <input type="text" name="numero" id="numero" class="form-control" value="<?= $hospede->getNumero() ?>" required>
                        </p>

                        <input type="hidden" name="id" value="<?= $hospede->getId() ?>">
