    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Hóspedes</h2>
                    <a href="create.php">Novo Hóspede</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $hospede) : ?>
                            <tr>
                                <td><?= $hospede->getId() ?></td>
                                <td><?= $hospede->getNome() ?></td>
                                <td><?= $hospede->getCpf() ?></td>
                                <td><?= $hospede->getCep() ?></td>
                                <td><?= $hospede->getNumero() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $hospede->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $hospede->getId() ?>" title="Excluir">
