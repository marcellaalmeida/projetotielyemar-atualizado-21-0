    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Status</h2>
                    <a href="create.php">Novo Status</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach ($dao->read() as $status) : ?>
                            <tr>
                                <td><?= $status->getIdStatus() ?></td>
                                <td><?= $status->getDescricao() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $status->getIdStatus() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $status->getIdStatus() ?>" title="Excluir">
