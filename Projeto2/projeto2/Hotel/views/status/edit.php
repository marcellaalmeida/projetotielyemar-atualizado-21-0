                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="descricao" id="descricao" class="form-control" value="<?= $status->getDescricao() ?>" required>
                        </p>

                        <input type="hidden" name="idstatus" value="<?= $status->getIdStatus() ?>">
