    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Statusreserva</h2>
                    <a href="create.php">Novo status da Reserva</a>
                    <table class="table table-hover">
                            <tr>
                                <th>ID statusreservaReserva</th>
                                <th>Descrição</th>
                                <th>Ações</th>
                            </tr>
                            <?php foreach ($dao->read() as $statusreserva) : ?>
                                <tr>
                                    <td><?= $statusreserva->getIdstatusreserva() ?></td>
                                    <td><?= $statusreserva->getDescricao() ?></td>
                                    <td>
                                        <a href="edit.php?id=<?= $statusreserva->getIdstatusreserva() ?>" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="destroy.php?id=<?= $statusreserva->getIdstatusreserva() ?>" title="Excluir">
