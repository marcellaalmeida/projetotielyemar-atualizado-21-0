<?php
    // Buscar as informações do Status para atualizar
    require "../../autoload.php";

    $dao = new StatusReservaDAO();
    $status = $dao->find($_GET['id']);
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Editar Status Da Reserva</h2>
                    <form action="update.php" method="post">
                        <P class="form-group">
                            <label for="descricao">Descrição:</label>
                            <input type="text" name="descricao" id="descricao" class="form-control" value="<?= $status->getDescricao() ?>" placeholder="Digite a descrição do status"required>
                        </p>

                        <input type="hidden" name="idstatusreserva" value="<?= $status->getIdStatusReserva() ?>">
